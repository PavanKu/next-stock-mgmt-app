...
export function StockOutListHeader() {
  ...
  const handleClearFiltersBtnClick = () => {
    setFilters({
      ...
      page: DEFAULT_PAGE,
      vendorId: "",
      type: OrderType.Sale, // Always set to sale for Stock Out
      dateFrom: "",
      dateTo: "",
    });
  };
  ...
  return (
    <>
      <NewSaleOrderDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} />
      <div className="py-4 px-4 md:px-8 flex flex-col gap-y-4">
        <div className="flex items-center justify-between">
          <h5 className="text-xl font-medium">Stock Out</h5>
